...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.0.3'
}
```

## Resources
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.0.3/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.0.3/gwtmvp-1.0.3.jar)
