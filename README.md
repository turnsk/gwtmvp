...
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.3.1/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.3.1/gwtmvp-1.3.1.jar)
...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.3.1'
}
```
