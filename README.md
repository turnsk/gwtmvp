...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.0.1'
}
```

## Resources
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.0.1/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.0.1/gwtmvp-1.0.1.jar)
