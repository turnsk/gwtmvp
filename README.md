...
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.6.4/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.6.4/gwtmvp-1.6.4.jar)
...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.6.4'
}
```
