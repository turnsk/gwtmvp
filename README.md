...
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.5/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.5/gwtmvp-1.5.jar)
...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.5'
}
```
