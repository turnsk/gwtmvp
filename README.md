...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.0.2'
}
```

## Resources
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.0.2/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.0.2/gwtmvp-1.0.2.jar)
