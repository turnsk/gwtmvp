...
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.8.3/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.8.3/gwtmvp-1.8.3.jar)
...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.8.3'
}
```
