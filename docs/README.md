...
* [Read Javadoc](https://jitpack.io/sk/turn/gwtmvp/1.8.4/javadoc/)
* [Download JAR](https://jitpack.io/sk/turn/gwtmvp/1.8.4/gwtmvp-1.8.4.jar)
...
dependencies {
  ...
  providedCompile 'sk.turn:gwtmvp:1.8.4'
}
```
